...
"""
    ...
    stage_block = build_stage1_block(df, interpretation)

    updated_html = insert_or_replace_block(html_content, "STAGE1", stage_block)

    report_path.write_text(updated_html, encoding="utf-8")

    print("✅ Stage 1 rebuilt correctly with structured block.")
