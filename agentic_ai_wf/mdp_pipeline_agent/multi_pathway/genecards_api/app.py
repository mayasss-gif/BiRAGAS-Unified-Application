...
# Try to get NEO4J_API_KEY from environment variables
...
def get_kg_data(disease_name: str) -> dict:
    """
...
# results = get_kg_data("breast cancer")
# with open("disease_scores.json", "w") as f:
